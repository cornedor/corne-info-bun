...
export default function DockerReg() {
  return (
    <>
      <Intro>
        Here is a simple setup that can be used to self-host a docker registry.
      ...
      <pre class="mb-4 overflow-auto rounded border-stone-200 bg-stone-50 p-2 shadow-md">{`version: '3'
